...
namespace VTDev.Libraries.CEXEngine.Crypto.Cipher.Asymmetric.Sign.RNBW.Arithmetic
{
    ...
    /// </summary>
    internal static class GF2Field
    {
        #region Fields
        public static readonly int MASK = 0xFF;
        // this lookup table is needed for multiplication and computing the multiplicative inverse
        private static readonly short[] _exps = 
        {
        ...
        // this lookup table is needed for multiplication and computing the multiplicative inverse
        private static readonly short[] _logs = 
        {
        ...
        public static short MultElem(short X, short Y)
        {
            if (X == 0 || Y == 0)
                ...
                return (_exps[(_logs[X] + _logs[Y]) % 255]);
        }
        #endregion
    }
}
